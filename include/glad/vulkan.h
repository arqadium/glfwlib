/**
 * Loader generated by glad 2.0.0-beta on Tue Mar 24 23:15:55 2020
 *
 * Generator: C/C++
 * Specification: vk
 * Extensions: 4
 ...
 * Commandline:
 *    --api='vulkan=1.0'
 * --extensions='VK_EXT_debug_report,VK_KHR_device_group,VK_KHR_surface,VK_KHR_swapchain'
 * c --loader --alias
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.0&extensions=VK_EXT_debug_report%2CVK_KHR_device_group%2CVK_KHR_surface%2CVK_KHR_swapchain&generator=c&options=LOADER%2CALIAS
 *
 */
...
#define VK_API_VERSION_1_0                                                     \
  VK_MAKE_VERSION(1, 0, 0) /* Patch version should always be set to 0 */
...
typedef void(GLAD_API_PTR *PFN_vkCmdDispatchBase)(
    ...
    uint32_t groupCountZ);
typedef void(GLAD_API_PTR *PFN_vkCmdDispatchBaseKHR)(
    VkCommandBuffer commandBuffer, uint32_t baseGroupX, uint32_t baseGroupY,
    uint32_t baseGroupZ, uint32_t groupCountX, uint32_t groupCountY,
    uint32_t groupCountZ);
...
typedef void(GLAD_API_PTR *PFN_vkCmdSetDeviceMaskKHR)(
    VkCommandBuffer commandBuffer, uint32_t deviceMask);
...
typedef void(GLAD_API_PTR *PFN_vkGetDeviceGroupPeerMemoryFeaturesKHR)(
    VkDevice device, uint32_t heapIndex, uint32_t localDeviceIndex,
    uint32_t remoteDeviceIndex, VkPeerMemoryFeatureFlags *pPeerMemoryFeatures);
...
#define vkGetDeviceGroupPeerMemoryFeatures                                     \
  glad_vkGetDeviceGroupPeerMemoryFeatures
GLAD_API_CALL PFN_vkGetDeviceGroupPeerMemoryFeaturesKHR
...
GLAD_API_CALL int gladLoaderLoadVulkan(VkInstance instance,
