...
MFLAGS.COMMON         := -pipe -fPIC -x objective-c -frandom-seed=69420 \
	-march=ivybridge -mtune=skylake
MFLAGS.COMMON.DEBUG   := -O0 -g -Wall
MFLAGS.COMMON.RELEASE := -O2 -w
MFLAGS.COMMON.CHECK   := -Wextra -Werror -Wno-unused-variable
ifeq ($(strip $(TC)),llvm)
MFLAGS.COMMON.COV     := -O1 -g3 -fprofile-arcs -ftest-coverage
else ifeq ($(strip $(TC)),xcode)
MFLAGS.COMMON.COV     := -O1 -g3 -fprofile-arcs -ftest-coverage
else
MFLAGS.COMMON.COV     := -O1 -g3 -fprofile-instr-generate \
	-fcoverage-mapping
endif
MFLAGS.COMMON.ASAN    := -O1 -g3 -fsanitize=address -fno-omit-frame-pointer
MFLAGS.COMMON.UBSAN   := -O1 -g3 -fsanitize=undefined \
	-fno-omit-frame-pointer
...
MFLAGS   += -ffile-prefix-map=OLD=NEW
...
export MFLAGS
export MFLAGS.COMMON
export MFLAGS.COMMON.DEBUG
export MFLAGS.COMMON.RELEASE
export MFLAGS.COMMON.CHECK
export MFLAGS.COMMON.COV
export MFLAGS.COMMON.ASAN
export MFLAGS.COMMON.UBSAN
export CXXFLAGS
